...
class thepack_cardslider extends Widget_Base
{
    ...
    {
        return esc_html__('Card slider', 'thepack');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'title' => esc_html__('Assertively network wireless', 'thepack'),
                    ]
                ],
                'title_field' => '{{{title}}}',
            ]
        ...
        $this->add_control(
            'dot',
            [
                'label' => esc_html__('Enable dot', 'thepack'),
        ...
        $this->start_controls_section(
            'section_caroucs',
            [
                'label' => esc_html__('Dot customiser', 'thepack'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'dot' => 'yes',
                ],
        ...
        $this->add_responsive_control(
            'dvp',
            [
                'label' => esc_html__('Dot right spacing', 'thepack'),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            'dt-m',
            [
                'label' => esc_html__('Dot main Color', 'thepack'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dt-s',
            [
                'label' => esc_html__('Dot secondary Color', 'thepack'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
