          ...
          <div class="navigation">
            <?php
              ...
              the_posts_pagination( array(
                'prev_text' => __( 'Previous page', 'vw-interior-designs' ),
                'next_text' => __( 'Next page', 'vw-interior-designs' ),
                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-interior-designs' ) . ' </span>',
              ) );
            ?>
