...
class VW_Interior_Designs_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Interior_Designs_About_Widget',
			__('VW About us', 'vw-interior-designs'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-interior-designs' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-interior-designs'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-interior-designs'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-interior-designs'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-interior-designs'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-interior-designs'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-interior-designs'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_interior_designs_about_custom_load_widget() {
	register_widget( 'VW_Interior_Designs_About_Widget' );
}
add_action( 'widgets_init', 'vw_interior_designs_about_custom_load_widget' );